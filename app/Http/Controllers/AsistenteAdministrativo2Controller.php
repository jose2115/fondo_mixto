...
class AsistenteAdministrativo2Controller extends Controller
{
    ...
    public function show($id)
    {
        if (request()->ajax()) {
           ...
           // $anexo = Anexo::where('solicitud_id', $id)->get();      
            ...
            return response()->view('ajax.detail-asistente', compact('estudio','anexo','solicitus','solicitud', 'historial'));
        }
