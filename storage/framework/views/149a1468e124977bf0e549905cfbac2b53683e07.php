    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
          ...
          <form id="form_edit" action="<?php echo e(route('empleados.update', 'empleado')); ?>" method="POST"
...
<?php /**PATH C:\laragon\www\parque\resources\views/modals/edit-empleado.blade.php ENDPATH**/ ?>