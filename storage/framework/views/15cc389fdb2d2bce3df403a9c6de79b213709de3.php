...
<div class="col-md-12 col-sm-12">
  ...
  <div class="boton" style="display:none">
     <button type="button"  id="btn_show_send6-<?php echo e($solicitud->id); ?>" 
     class="btn btn-success btn-sm asis" onclick="enviarAsistente(this);" 
     data-id="asis" data-href="<?php echo e(route('solicitud.asistente', $solicitud->id)); ?>" 
    ...
    <div class="table-responsive">
      <table id="id_table" class="table table-hover table-sm mejoratb">
        ...
        <?php $__currentLoopData = $solicitud->observaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
            <input type="hidden" id = "estado_so" value="<?php echo e($item->estado); ?>">  
              <td><?php echo e($loop->iteration); ?></td>
              <td>
              ...
              <td><?php if( $item->pago == 1): ?>
                    <?php echo e('50% - 50% (Anticipo)'); ?>

                    <?php else: ?>
                    <?php echo e('100% (Al finalizar)'); ?>
...
<div class="col-md-12 col-sm-12">
  ...
  <!-- /.card -->
</div><?php /**PATH C:\laragon\www\parque\resources\views/ajax/detail-management.blade.php ENDPATH**/ ?>