        ...
        <div id="datos">
          <table class="table table-condensed table-responsive" style="width: 100%;">
            ...
            <tr>
              ...
              <td><input value="<?php echo e($solicitud->solicitante->nombre); ?> <?php echo e($solicitud->solicitante->apellido); ?>" type="text" class="form-control" id="beneficiario" name="beneficiario"></td>   
              <td><input type="text" class="form-control" id="cheque" name="cheque"></td>
              <td><input value="<?php echo e($solicitud->solicitante->nid); ?>" type="number" class="form-control" id="nit" name="nit"></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\parque\resources\views/comprobantes/create-comprobante.blade.php ENDPATH**/ ?>