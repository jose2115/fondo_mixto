...
<link rel="stylesheet" href="<?php echo e(asset('css/util_form.css')); ?>">
    <img src="<?php echo e(asset('img/logo_cultura2.png')); ?>"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="width:2em">
    <span class="brand-text font-weight-light letra">Cultura</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="javascript:void(0)" class="d-block"><?php echo e(Auth::user()->usario); ?></a>
      </div>
    </div>
...
<?php /**PATH C:\laragon\www\parque\resources\views/layouts/menu.blade.php ENDPATH**/ ?>