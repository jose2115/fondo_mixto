  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-hover table-sm mejoratb">
          ...
          <tbody>
              <?php $__currentLoopData = $solicitus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td class="text-center"><?php echo e($loop->iteration); ?></td>
                  <td ><?php echo e($a->tipo_documento); ?></td>
                  <td >
                    <a class="btn btn-info btn-sm" target="_blank" href="<?php echo e(asset('documentos/solicitudes/')); ?>/<?php echo e($a->solicitud_id.'/'.$a->name); ?>">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-hover table-sm mejoratb">
          ...
          <tbody>
              <?php $__currentLoopData = $estudio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td class="text-center"><?php echo e($loop->iteration); ?></td>
                  <td ><?php echo e($a->tipo_documento); ?></td>
                  <td >
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-hover table-sm mejoratb">
          ...
          <tbody>
              <?php $__currentLoopData = $minuta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td class="text-center"><?php echo e($loop->iteration); ?></td>
                  <td ><?php echo e($a->tipo_documento); ?></td>
                  <td >
...
<?php /**PATH C:\laragon\www\parque\resources\views/ajax/detail-juridica.blade.php ENDPATH**/ ?>