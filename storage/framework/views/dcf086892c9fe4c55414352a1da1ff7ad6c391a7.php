    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <button type="button" id="btn_show_detail-<?php echo e($solicitud->id); ?>" class="btn btn-info btn-sm show-details" data-toggle="modal" data-href="<?php echo e(route('proyectos.show', $solicitud->id)); ?>" data-target="#modalShow"><i class="fas fa-eye" data-toggle="tooltip" data-placement="top" title="VER DETALLE"></i></button>
...
<?php /**PATH /home/fomiclo27/public_html/resources/views/ajax/table-solicitudes-proyectos.blade.php ENDPATH**/ ?>