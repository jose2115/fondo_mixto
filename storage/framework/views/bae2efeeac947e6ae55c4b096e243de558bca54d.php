    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
            <form id="form_create" action="<?php echo e(route('lineas.store')); ?>" method="POST" onkeypress="return disableEnterKey(event);">
                <?php echo csrf_field(); ?>
                <div class="form-row">
                    <div class="col-md-12">
...
<?php /**PATH C:\laragon\www\parque\resources\views/modals/create-lineas.blade.php ENDPATH**/ ?>