    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
            <form id="form_create" action="<?php echo e(route('proponente.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-row">
                    <div class="col-md-12">
...
<?php /**PATH /home/fomiclo27/public_html/resources/views/modals/create-proponentes.blade.php ENDPATH**/ ?>