    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <button type="button" id="btn_show_detail-<?php echo e($solicitud->id); ?>" class="btn btn-info btn-sm show-details" data-toggle="modal" data-href="<?php echo e(route('solicitud2.show', $solicitud->id)); ?>" data-target="#modalShow"><i class="fas fa-eye" data-toggle="tooltip" data-placement="top" title="VER DETALLE"></i></button>
           </td>
        </tr>
...
<?php /**PATH C:\laragon\www\parque\resources\views/ajax/table-solicitudes-filtro.blade.php ENDPATH**/ ?>