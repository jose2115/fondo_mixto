    ...
    <tbody>
        <?php $__currentLoopData = $solicitantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e($solicitante->name_complete); ?></td>
            <td><?php if($solicitante->razon_social): ?> <span class="badge bg-gradient-warning"> <?php echo e($solicitante->razon_social); ?> </span> <?php else: ?> <span class="badge bg-gradient-warning">Persona Natural</span> <?php endif; ?></td>
                ...
                <td class="text-center">
                   <button type="button"  class="btn btn-primary" data-toggle="modal" data-target="#modalEdit" data-id="<?php echo e($solicitante->id); ?>"   data-persona_id="<?php echo e($solicitante->persona_id); ?>"  data-proponente_id="<?php echo e($solicitante->proponente_id); ?>"
                    ...
                    data-representante_legal="<?php echo e($solicitante->representante_legal); ?>" > <i class="fas fa-pencil-alt" data-toggle="tooltip" data-placement="top" title="EDITAR"></i></button>
                </td>
            </tr>
...
<?php /**PATH /home/fomiclo27/public_html/resources/views/ajax/table-solicitantes.blade.php ENDPATH**/ ?>