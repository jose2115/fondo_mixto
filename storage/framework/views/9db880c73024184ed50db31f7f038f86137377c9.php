...
<div class="row mb-2">
  <div class="col-sm-12 text-center letra_titulo">
    <p>Solicitudes Director Administrativo</p>
  </div>
</div>
...
<div class="container-fluid">
  ...
  <div class="card card" style="background:#EBF5FB">
    ...
    <div class="card-body table-responsive" id="id_table">
        <?php echo $__env->make('ajax.table-solicitudes-director', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- /fin tabla-->
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fomiclo27/public_html/resources/views/director/index.blade.php ENDPATH**/ ?>