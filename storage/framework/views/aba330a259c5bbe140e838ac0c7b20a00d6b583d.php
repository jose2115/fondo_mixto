    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
            <form id="form_edit" action="<?php echo e(route('proponente.update', 'proponentes')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/fomiclo27/public_html/resources/views/modals/edit-proponentes.blade.php ENDPATH**/ ?>