    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:whitesmoke">
            <form id="form_perfil" action="<?php echo e(route('update.perfil', auth()->user()->id)); ?>" method="POST" onkeypress="return disableEnterKey(event);">
                <?php echo csrf_field(); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <th>USUARIO</th>
                            <td><?php echo e(auth()->user()->documento); ?></td>
                        </tr>
                        <tr>
...
<?php /**PATH /home/fomiclo27/public_html/resources/views/modals/edit-perfil.blade.php ENDPATH**/ ?>