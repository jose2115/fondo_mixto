    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
            <form id="form_edit" action="<?php echo e(route('lineas.update', 'lineas')); ?>" method="POST" onkeypress="return disableEnterKey(event);">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\parque\resources\views/modals/edit-lineas.blade.php ENDPATH**/ ?>