<div class="modal fade" id="modalAnexos2" data-backdrop="static">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background:#E1E2E3">
            <form id="form2" action="<?php echo e(route('anexos.store')); ?>" method="POST">
                    ...
                    <div class="form-row">        
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="documento_id" id="documento_id" class="form-control" style="width: 100%;">
                                    <?php $__currentLoopData = $docus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-success" id="add-anexo2">Agregar <i class="fas fa-times-circle"></i></button>
...
<?php /**PATH C:\laragon\www\parque\resources\views/modals/add-anexos2.blade.php ENDPATH**/ ?>