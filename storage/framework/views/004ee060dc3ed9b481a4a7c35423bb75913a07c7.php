...
<div class="col-md-12 col-sm-12">
  ...
  <div class="card-body">
    ...
    <button type="button"  id="btn_show_send-<?php echo e($solicitud->id); ?>"
        ...
        data-href="<?php echo e(route('solicitud.juridica', $solicitud->id)); ?>"
  ...
  <?php if($solicitud->categoria->tipo_solicitud == 'Proyecto'): ?>
      ...
      <div class="card-body">
        <dl class="row">
            ...
            <dd class="col-sm-8">
                <?php if($solicitud->solicitante->razon_social): ?>
                <?php echo e($solicitud->solicitante->razon_social); ?>loca
                <?php else: ?>
                <?php echo e($solicitud->solicitante->nombre); ?> <?php echo e($solicitud->solicitante->apellido); ?>
...
<?php /**PATH C:\laragon\www\parque\resources\views/ajax/detail-asistente.blade.php ENDPATH**/ ?>