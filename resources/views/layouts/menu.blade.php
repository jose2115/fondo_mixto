...
<link rel="stylesheet" href="{{asset('css/util_form.css')}}">
    <img src="{{asset('img/logo_cultura2.png')}}"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="width:2em">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="javascript:void(0)" class="d-block">{{Auth::user()->usario}}</a>
      </div>
    </div>
