        ...
        <div id="datos">
          <table class="table table-condensed table-responsive" style="width: 100%;">
            ...
            <tr>
              ...
              <td><input value="{{ $solicitud->solicitante->nombre}} {{ $solicitud->solicitante->apellido }}" type="text" class="form-control" id="beneficiario" name="beneficiario"></td>   
              <td><input type="text" class="form-control" id="cheque" name="cheque"></td>
              <td><input value="{{ $solicitud->solicitante->nid}}" type="number" class="form-control" id="nit" name="nit"></td>
