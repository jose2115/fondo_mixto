...
@section('titulo', "Módulo de Comprobantes")
...
<div class="container-fluid">
  ...
  <div class="card card" style="background:#EBF5FB">
    <div class="card-header">
      <a class="btn btn-success" href='{{ route("comprobantes.create") }}'>
    ...
    <div class="card-body table-responsive" id="id_table">
      @include('ajax.table-comprobantes')
  </div>
    <!-- /fin tabla-->
...
<script src="{{asset('js/index-comprobante.js')}}"></script>
